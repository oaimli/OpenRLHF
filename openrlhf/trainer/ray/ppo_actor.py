...
class ActorPPOTrainer(ABC):
    ...
    def training_step(self, experience: Experience, kl_ctl: float, step: int) -> Dict[str, float]:
        ...
        output_full_logits = output_full["logits"][:, :-1, :, :]
        ...
        output_logits = output_logits[target_index: target_index + 1].detach()[action_mask[target_index: target_index + 1] == 1]
        output_full_logits = output_full_logits[action_mask_full == 1]
